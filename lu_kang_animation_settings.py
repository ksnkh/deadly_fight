liu_kan_move_animations = {'stand': [8, [55, 55, 59, 59, 55, 55, 55, 48], [1] * 8, [0, 7], True, False],
                           'walk_f': [9, [50, 46, 40, 44, 48, 46, 46, 46, 41], [1] * 9, [0, 8], True, False],
                           'walk_b': [9, [50, 46, 40, 44, 48, 46, 46, 46, 41], [1] * 9, [0, 8], True, False],
                           'jump': [4, [59, 55, 60, 45], [3, 3, 5, 3], [0, 3],  False, False],
                           'move_jump': [9, [47, 41, 47, 50, 49, 42, 47, 57, 40], [1] * 9, [1, 8], False, False],
