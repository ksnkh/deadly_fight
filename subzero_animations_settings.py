...
subzero_move_animations = {'stand': [12, [51] * 12, [1] * 12, [0, 11], True, False],
                           ...
                           'high_punch': [3, [60, 60, 71], [1, 1, 5], [], False, [[2], 'weak_hit', 150, [4, 0]]],
                           ...
                           'uppercut': [6, [56, 60, 82, 53, 52, 55], [1, 1, 1, 6, 1, 1], [], False, [[2, 3, 4], 'heavy_hit', 60, [8, -20]]],
                           'sweep_kick': [8, [57, 55, 56, 89, 88, 53, 79, 50], [1] * 8, [], False, [[3, 4], 'trip', 40, [0, 0]]],
                           'roundhouse': [8, [57, 62, 87, 61, 53, 54, 60, 50], [1] * 8, [], False, [[2, 3], 'heavy_hit', 70, [8, -20]]],
                           'throw': [7, [66, 84, 61, 62, 53, 78, 78], [1] * 7, [], False, [[3], 'thrown', 60, [-8, -20]]],
                           ...
                           'heavy_hit': [6, [79, 82, 63, 53, 79, 100], [1, 1, 5, 1, 1, 1], [], False, False],
