...
subzero_move_animations = {'stand': [12, [58] * 12, [1] * 12, [0, 11], True, False],
                           'walk_f': [9, [33] * 9, [1] * 9, [0, 8], True, False],
                           'walk_b': [9, [33] * 9, [1] * 9, [0, 8], True, False],
                           'jump': [3, [54] * 3, [3, 3, 5], [0, 2], False, False],
                           ...
                           'high_kick': [6, [55, 56, 45, 65, 88, 64], [1, 1, 1, 1, 3, 1], [], False,
                                         [[4], 'weak_hit', 50, [6, 0]]],
