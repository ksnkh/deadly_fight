...
for i in range(len(data)):
    if i == 0:
        ...
        control['НИЗКИЙ УДАР'] = data[i]
    elif i == 5:
        control['ВЫСОКИЙ УДАР'] = data[i]
    elif i == 6:
        control['НИЗКИЙ ПИНОК'] = data[i]
    elif i == 7:
        control['ВЫСОКИЙ ПИНОК'] = data[i]
    elif i == 8:
...
class Settings:
    def __init__(self, music_class, sound_class):
        ...
        self.points = [[30, 100, 'Музыка: вкл', (128, 128, 128), (210, 50, 0), 0],
                       ...
                       (350, 260, 'НИЗКИЙ УДАР', (128, 128, 128), (210, 50, 0), 7),
                       (350, 300, 'ВЫСОКИЙ УДАР', (128, 128, 128), (210, 50, 0), 8),
                       (350, 340, 'НИЗКИЙ ПИНОК', (128, 128, 128), (210, 50, 0), 9),
                       (350, 380, 'ВЫСОКИЙ ПИНОК', (128, 128, 128), (210, 50, 0), 10),
                       ...
                       [620, 260, control['НИЗКИЙ УДАР'], (128, 128, 128), (210, 50, 0), 7],
                       [620, 300, control['ВЫСОКИЙ УДАР'], (128, 128, 128), (210, 50, 0), 8],
                       [620, 340, control['НИЗКИЙ ПИНОК'], (128, 128, 128), (210, 50, 0), 9],
                       [620, 380, control['ВЫСОКИЙ ПИНОК'], (128, 128, 128), (210, 50, 0), 10],
