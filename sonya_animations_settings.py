...
sonya_move_animations = {'stand': [7, [47, 48, 46, 46, 46, 46, 37], [1] * 7, [0, 11], True, False],
                         ...
                         'duck': [2, [46, 36], [1] * 4, [2, 2], False, False],
                         'block': [3, [50, 48, 32], [2, 1], [0, 0], False, False],

                           'high_punch': [3, [60, 60, 71], [1, 1, 5], [], False, [[2], 'weak_hit', 30, [4, 0]]],
                           'low_punch': [2, [60, 70], [1, 5], [], False, [[1], 'weak_hit', 30, [4, 0]]],
                           'high_kick': [5, [51, 48, 78, 74, 52], [1, 1, 1, 3, 1], [], False,
                                         [[3], 'weak_hit', 50, [6, 0]]],
                           ...
                           'throw': [7, [41, 64, 69, 50, 64, 51, 51], [1] * 6, [], False,
                                     [[2], 'thrown', 60, [-10, -20]]],
                           'air_kick': [2, [46, 67], [2, 2], [], False, [[1], 'weak_hit', 40, [7, 0]]],
                           'leg_throw': [6, [60, 75, 78, 65, 51, 63], [1] * 12, [], False,
                                     [[5], 'thrown', 60, [-10, -20]]],
                           ...
                           'thrown': [6, [54, 56, 55, 66, 71, 84], [1, 1, 1, 1, 1, 5], [], False, False],
